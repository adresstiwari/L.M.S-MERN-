    ...
    <HomeLayout>
      <div className="flex items-center justify-center overflow-x-auto h-[100vh]">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-yellow-500 text-white font-semibold p-2 rounded-sm hover:bg-yellow-400 transition-all ease-in-out duration-300 hover:text-white text-xl cursor-pointer py-2 mt-6"
          >
            Login
          </button>
