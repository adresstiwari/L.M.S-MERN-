...
function CourseDescription() {
  ...
  return (
    <HomeLayout>
      <div className="min-h-[99vh] pt-12 px-20 flex items-center justify-center flex-col text-white">
  ...
  Watch lectures
          ...
          <div className="space-y-2 text-xl">
            ...
            <p className="text-xl text-white">{state?.description}</p>
          </div>
        </div>
      </div>
    </HomeLayout>
